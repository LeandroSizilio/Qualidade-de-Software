...
export class DelegacyService {
  getNatalDelegacies(): DelegacyData[] {
    return [
      {
        title: 'Delegacia Especializada de Atendimento à Mulher em Natal',
        address:
      ...
      {
        title: 'Delegacia Especializada de Atendimento à Mulher em Natal',
        address: 'R. do Saneamento, 28 - Ribeira, Natal - RN, 59012-410.',
        addressUrl:
      ...
      {
        title: 'Delegacia Especializada de Atendimento à Mulher em Natal',
        address: 'Av. Hermes da Fonseca, 1174 - Tirol, Natal - RN, 59020-315',
        addressUrl:
      ...
      {
        title: 'Delegacia Especializada de Atendimento à Mulher em Natal',
        address: 'Av. Guadalupe, 2145 - Potengi, Natal - RN, 59112-560',
        addressUrl:
      ...
      {
        title: 'Delegacia Especializada de Atendimento à Mulher em Parnamirim',
        address:
